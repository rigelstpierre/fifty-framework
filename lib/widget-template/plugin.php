 ...
 * @since 1.0
 */
class FFW_Widget_Template extends WP_Widget {

	/*--------------------------------------------------------*
	 * Set Vars
	 *--------------------------------------------------------*/
	$widget_options = array(
		'option_1' 		 => __( 'Title', 'FFW' ),
		'option_2'   => __( 'Facebook URL', 'FFW' ),
		'option_3' => __( 'Google Plus URL', 'FFW' ),
		'option_4'    => __( 'Twitter URL', 'FFW' ),
	);
...
add_action( 'widgets_init', create_function( '', 'register_widget( "FFW_Widget_Template" );' ) ); 
?>